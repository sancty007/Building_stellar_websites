...
// TODO: Le header de la home page est different du header des autres pages????
export const Header = () => {
  return (
    <>
      <div className=" hidden lg:flex justify-between items-center bg-port-core px-40 py-4 ">
        ...
        <div className="flex  items-center tex-gray-Suit justify-center gap-12">
          ...
          <div className="flex items-center justify-center">
            <HeaderButton style="px-12 py-4  text-xs bg-port-core text-white border-2 border-gray-100 rounded-3xl  hover:bg-transparent bg-opacity-0" />
          </div>
        </div>
      </div>
    </>
      ...
      <section className="bg-port-core md:py-32">
        <div className="container lg:grid grid-cols-1 md:grid-cols-2">
          <Card className=" rounded-none bg-port-core border-none space-y-8 ">
            <CardTitle className=" text-white md:mb-8 md:text-5xl">
              Building stellar websites for early startups
            </CardTitle>
            <CardDescription className="md:mb-12 ">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
              eiusmod tempor incididunt.
            </CardDescription>
            <CardFooter className="flex p-0 gap-x-10">
              <Button className="bg-Salomie rounded-full px-12 py-4">
                View our work
              </Button>
